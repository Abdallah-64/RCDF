...
const serviceImage = z.string().url().or(z.string().max(1_100_000, 'Image is too large.').regex(/^data:image\/(png|jpeg|webp);base64,/, 'Use a PNG, JPEG, or WebP image.')).or(z.literal(''));
